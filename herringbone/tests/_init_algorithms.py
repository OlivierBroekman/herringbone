...
try:
    N = 5
    mc_predictor = MonteCarloPredictor(demo_mdp, discount=0.9, seed=42)
...
try:
    mc_control = MonteCarloController(demo_mdp, discount=0.9, epsilon=0.1, seed=42, start_coords=(0,0))
